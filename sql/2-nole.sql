...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2018 a las 12:50:38
...
CREATE TABLE IF NOT EXISTS `filatelia` (
  `Id` int(11) NOT NULL,
  `Anyo` int(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `libros_comics` (
  `Id` int(11) NOT NULL,
  `Anyo` int(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `numismatica` (
  `Id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `producto_ofrecido` (
  `ID` int(11) NOT NULL,
  `Nombre` varchar(20) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `producto_solicitado` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_user` (`id_user`,`categoria`,`id_Producto`),
  KEY `categoria` (`categoria`),
...
CREATE TABLE IF NOT EXISTS `puja` (
  ...
  KEY `IdPostor` (`IdPostor`),
  KEY `IdTrueque` (`IdTrueque`),
...
CREATE TABLE IF NOT EXISTS `rincon_de_la_abuela` (
  `Id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trastero` (
  `Id` int(11) NOT NULL,
  `Anyo` int(4) NOT NULL,
  `Origen` varchar(60) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `vinilos_discos` (
  `Id` int(11) NOT NULL,
  `Anyo` int(4) NOT NULL,
